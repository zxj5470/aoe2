...
| Story | 野猪模型改为方块拼接形状 | 2026-06-02 |
| Story | 野猪模型比例调整避免像黄牛 | 2026-06-02 |
| Story | 保留当前模型为鳄鱼函数并恢复黄牛函数 | 2026-06-02 |
| Bug | 人物走到地图边缘时疑似无法寻路 | 2026-06-02 |
| Bug | 人物拾取需要鼠标触到底部而非射线命中优先 | 2026-06-02 |
| Bug | 距离1格以内点击采集人物不会正常采集 | 2026-06-02 |
| Bug | 近距离点击伐木时采集位置不正确 | 2026-06-02 |
